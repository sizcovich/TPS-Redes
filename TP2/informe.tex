...
\caption{Ruta a la International University of South Africa desde servicio Fibertel.}
\end{center}
\end{figure}
...
\caption{Ruta a la International University of South Africa desde servicio Telefónica.}
\end{center}
\end{figure}
...
\caption{Ruta a la University of Zurich desde servicio Fibertel.}
\end{center}
\end{figure}
...
\caption{Ruta a la University of Zurich desde servicio Telefónica.}
\end{center}
\end{figure}
...
\caption{Ruta a la University of Japan desde servicio Fibertel.}
\end{center}
\end{figure}
...
\caption{Ruta a la University of Japan desde servicio Telefónica.}
\end{center}
\end{figure}
