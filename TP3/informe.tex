...
Sin embargo, en los gráficos realizados para medir la cantidad de retransmisiones, vemos que los mejores valores obtenidos para que haya la minima cantidad de las mismas es de $ 0.8 \leq \alpha \leq 1$ y $ 0.3 \leq  \beta \leq 0.6$.
