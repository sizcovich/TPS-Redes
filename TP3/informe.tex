...
\item \textbf{RTO:} Consiste en un RTT estimado definido en función de $\alpha$ y $\beta$ para un delay fijo. Cantidad de retransmisiones en función de $\alpha$ y $\beta$. Comparación entre el RTO y el RTT ``real''.\footnote{https://tools.ietf.org/html/rfc6298}
