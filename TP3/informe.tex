...
Para realizar este test, se midió los RTTs de las paquetes transmitidos en una ejecución para luego simular el calculo de RTO en función de alpha y beta.
Para el cálculo del RTO se abstrajo el mismo del código de PTC y se lo encapsuló en la clase RTOcalculator. De esta manera, podemos comparar para una transmisión como varia el mismo en función de alpha y beta.

\subsubsection{ Diferencia RTT-RTO en función de $\alpha$ y $\beta$ con delay en los primeros 50 paquetes}
\begin{figure}[H]
\begin{center}
\includegraphics[width=17cm]{delay-50F.png}
\caption{Diferencia RTT-RTO en función de $\alpha$ y $\beta$ con delay en los primeros 50 paquetes.}
\end{center}
\end{figure}
...
\subsubsection{Diferencia RTT-RTO en función de $\alpha$ y $\beta$ con delay en los últimos 50 paquetes}
\begin{figure}[H]
\begin{center}
\includegraphics[width=17cm]{delay-50L.png}
\caption{Diferencia RTT-RTO en función de $\alpha$ y $\beta$ con delay en los últimos 50 paquetes.}
\end{center}
\end{figure}
...
\subsubsection{Diferencia RTT-RTO en función de $\alpha$ y $\beta$ con delay en los primeros y últimos 30 paquetes}
\begin{figure}[H]
\begin{center}
\includegraphics[width=17cm]{delay-30F.png}
\caption{Diferencia RTT-RTO en función de $\alpha$ y $\beta$ con delay en los primeros y últimos 30 paquetes.}
\end{center}
\end{figure}
...
\subsubsection{Diferencia RTT-RTO en función de $\alpha$ y $\beta$ con delay en los 30 paquetes intermedios}
\begin{figure}[H]
\begin{center}
\includegraphics[width=17cm]{delay-30I.png}
\caption{Diferencia RTT-RTO en función de $\alpha$ y $\beta$ con delay en los 30 paquetes intermedios.}
\end{center}
\end{figure}
...
test de comparacion de RTT vs RTO con delay
la idea es ver con que valores de alpha y beta se adapta mejor a los cambios
